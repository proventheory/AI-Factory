...
const stickyGreenBrand = {
  ...
  design_tokens: {
    // Palette from stickygreenflower.com: logo/rewards #1E7C4D, CTA #1B523E, footer/promo #1A5141 / #0C342C
    color: {
      brand: {
        "50": "#e8f5ec",
        "100": "#c3e8d1",
  ...
  deck_theme: {
    chart_color_sequence: ["#1E7C4D", "#1B523E", "#1A5141", "#3db86d", "#6bc992", "#0C342C"],
    font_config: { heading: "Inter", body: "Inter" },
    slide_master: { title_font: "Inter", title_size: "1.875rem", title_weight: 700 },
  },
  report_theme: {
    header_style: { background: "#0C342C", text: "#ffffff" },

...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/evolution/mutations", label: "Evolution: Mutations", branchId: "orchestration" },
      { href: "/evolution/experiments", label: "Evolution: Experiments", branchId: "orchestration" },
      { href: "/evolution/scoreboard", label: "Evolution: Scoreboard", branchId: "orchestration" },
    ],
  },
  {
    title: "CONFIG",

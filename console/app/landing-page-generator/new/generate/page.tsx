    ...
    try {
      ...
      const campaign = await createCampaign.mutateAsync({
        ...
        metadata_json: {
          ...
          campaign_prompt: campaignPrompt || "landing page",
      ...
      for (let i = 0; i < 120; i++) {
        ...
        if (status.status === "succeeded") {
          ...
          for (let attempt = 0; attempt < 8; attempt++) {
            ...
            let emailArtifact = items.find((a) => a.artifact_type === "email_template" || a.artifact_class === "email_template");
      ...
      <Stack>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. Weight loss offer landing page"
        ...
        <div className="flex flex-wrap gap-3">
          <Button
            ...
            disabled={busy || createCampaign.isPending || !hasTemplate}
          ...
          <Button variant="secondary" asChild disabled={busy}>
            <Link href="/landing-page-generator/new/content">Back</Link>
          </Button>
          <Button variant="secondary" asChild disabled={busy}>
            <Link href="/landing-page-generator">Cancel</Link>
          </Button>
        </div>
      </Stack>
    </PageFrame>
...
export default function LandingPageGeneratorNewGeneratePage() {
  return (
    <Suspense
      fallback={
        <PageFrame>
          <Stack>
            <PageHeader title="Generate" description="Create campaign and run the pipeline." />

...
function LandingPageContentPageInner() {
  ...
  const handleNext = async () => {
    ...
    const buildGenerateUrl = () => {
      ...
      return q ? `/landing-page-generator/new/generate?${q}` : "/landing-page-generator/new/generate";
    };
    if (toCopy.length === 0) {
      ...
      <Stack>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button variant="secondary" asChild>
            <Link href="/landing-page-generator/new/template">Back</Link>
          </Button>
        </div>
      </Stack>
    </PageFrame>
...
export default function LandingPageGeneratorNewContentPage() {
  return (
    <Suspense
      fallback={
        <PageFrame>

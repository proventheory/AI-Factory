    ...
    <PageFrame>
      <Stack>
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-4">
          ...
          <p className="mb-3 text-body-small text-text-muted">
            Document and email templates are managed in <Link href="/document-templates" className="text-brand-600 hover:underline">Document Templates</Link>. Templates can optionally be linked to a brand from the template or brand settings.
          </p>
        </section>
